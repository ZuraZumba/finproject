#!/bin/bash
# export GITHUB_PERSONAL_ACCESS_TOKEN=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
set -o errexit
set -o nounset
set -o pipefail
...
# HTML_OWNER=$(echo "$HTML_REPO_URL" | cut -d':' -f2 | cut -d'/' -f1)
...
github_repo="ZuraZumba/finaluri"
